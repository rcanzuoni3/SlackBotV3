...
{
	class TicTacToeType : CommandType
	{
		public override List<string> CommandNames() { return new List<string>() { "ttt" }; }
		public override string Help(string commandName) { return "Tic-Tac-Toe! A Game of X's and O's!"; }
		...
		{
			return typeof(TicTacToe);
		}

		class TicTacToe : CommandHandler
		{
			...
			public TicTacToe(SlackBotV3 bot) : base(bot) { }
