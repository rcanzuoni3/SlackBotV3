...
{
	public class GoodJobType : ICommandType
	{
		private ICommandHandlerProvider commandHandlerProvider;
		public List<string> CommandNames() { return new List<string>() { "goodjob", "badjob", "gj", "bj", "checkjobs" }; }
		public string Help(string commandName) { return "Type goodjob or badjob followed by a user's name and a description of the job"; }
		...
		public Type GetCommandHandlerType() { return typeof(GoodJob); }
		...
		public GoodJobType() : this(new CommandHandlerProvider()) { }

		public GoodJobType(ICommandHandlerProvider commandHandlerProvider)
		{
			this.commandHandlerProvider = commandHandlerProvider;
		}
	}

	public class GoodJob : ICommandHandler
	{
